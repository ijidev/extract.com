            ...
            @foreach ($notify as $notice)
              @if ($notice->is_read == false)
                <a href="#" class="dropdown-item dropdown-item-unread"> <span
                    class="dropdown-item-icon bg-danger text-white"> <i class="fas
                                                fa-bell"></i>
                  </span> <span class="dropdown-item-desc">{{$notice->title}}<span class="time">Unread</span>
                  </span>
                </a>
              @else
                <a href="#" class="dropdown-item"> <span class="dropdown-item-icon bg-info text-white"> <i class="far
                                                fa-bell"></i>
                  </span> <span class="dropdown-item-desc"> {{$notice->title}} <span class="time">Read</span>
                  </span>
                </a> 
              @endif
            @endforeach
