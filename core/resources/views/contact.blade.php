...
<div class="card">
  <div class="card-body text-center">
      ...
      {{-- <br> --}}
      <strong>Support@extract-tl-market.com</strong> <br>
      {{-- @dd($set->tg) --}}
       ...
       <a href="https://widget-page.smartsupp.com/widget/79481796682582291e554821fda8fa147bce4e14" disabled class="btn btn-info m-2" style="width:90%;">livechat</a>
