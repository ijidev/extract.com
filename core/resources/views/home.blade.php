...
@section('content')
    ...
    <section class="mainInfo">
        <div class="container">
          <div class="welcomeMessage mt-4">
              ...
              <p class="mainMesssage">welcome to Extract Marketing for any inquiries, please do not hesitate to contact Customer Care services</p>
          </div>
          ...
          <div class="text-center text-bold bg-light" style="border-radius: 10px; padding:10px;">
            ...
            <h6>
              Extract offers custom software development services that help innovative companies and 
    ...
    <section class="levels">
        ...
        <div class="rights d-flex mb-5">
            <p class="mx-auto my-5 mb-4 small">2024 Extract Transform Load Marketing. All rights reserved.</p>
        </div>
